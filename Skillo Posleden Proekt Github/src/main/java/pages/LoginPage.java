...
public class LoginPage extends BasePage {
    ...
    String toastMsgSuccessLogoutText;
    ...
    public String getToastMsgSuccessLogout() {
        mediumWait.until(ExpectedConditions.visibilityOf(toastMsgSuccessLogout));
        return toastMsgSuccessLogoutText = toastMsgSuccessLogout.getText().trim();
    }
